...
- Model lives in `STSTest/GameData.h` and stays as plain data structs.
- View classes read model pointers only and do not mutate gameplay state.
- Controller logic currently lives in `STSTest/main.cpp`.
...
- Source audio assets now live in `STSTest/Assets/Audio`.
